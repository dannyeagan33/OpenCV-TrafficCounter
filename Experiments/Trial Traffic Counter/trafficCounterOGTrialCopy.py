...
IMAGE_DIR = "images"
IMAGE_FILENAME_FORMAT = IMAGE_DIR + "/frame_%04d.png" #don't understand what this does

# Support either video file or individual frames
CAPTURE_FROM_VIDEO = True
if CAPTURE_FROM_VIDEO:
    IMAGE_SOURCE = "00002517.ASF" # Video file
else:
...
def process_frame(frame_number, frame, bg_subtractor, car_counter):
    ...
    for (i, match) in enumerate(matches):
        ...
        # write car count on frame
        font = cv2.FONT_HERSHEY_SIMPLEX # import font
        carCountString = "count = %d" % (car_counter.vehicle_count)
        cv2.putText(processed,carCountString, (200,200), font, 1, (255,255,0), 2, cv2.LINE_AA)
...
def main():
    ...
    foreground = bg_subtractor.apply(default_bg, None, 1.0)
